    ...
    <div className="fixed left-0 right-0 top-0 bottom-0 bg-black/40">
        ...
        <div className="w-5xl bg-white min-h-6 rounded-2xl mx-auto mt-4 px-5">
          ...
          <div className="mt-5 pb-5 h-[450px] overflow-y-auto">
            ...
            <div className="flex gap-5 mt-6">
              ...
              <div
                className={`w-1/2 mt-4 flex flex-col relative ${type !== "ADD" ? "opacity-60 cursor-not-allowed" : ""}`}
              >
                <label>
            ...
            <div className="mt-5">
              ...
              <div className="flex justify-center mt-2">
                <label
                  className="flex items-center text-white gap-3 bg-green-500 rounded-lg px-2 py-1"
                  htmlFor="uploadAvatar"
                >
                  <p className="cursor-pointer">Tải ảnh lên</p>
                  <span>
                    <CiCirclePlus size={"1.25rem"} />
                  </span>
                </label>
                <input
                  type="file"
          ...
          <div className="flex gap-6 justify-end py-5 pr-5">
            ...
            {type === "UPDATE" && (
              <button
                className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded-full cursor-pointer"
                onClick={() => {
                  handleClickUpdate();
                }}
              >
      ...
      {type === "DELETE" && (
        <div className="w-2xl bg-white min-h-6 rounded-xl mx-auto px-5 mt-10">
          <div className="flex justify-between py-3 border-b">
            <p className="text-xl font-semibold">Xóa người dùng</p>
            <span className="cursor-pointer" onClick={() => handleClickClose()}>
              <IoMdClose size={"1.5rem"} />
            </span>
          </div>
          <div className="p-5 h-48">
            <p className="font-semibold">
              Bạn chắc có muốn xóa người dùng {payload.firstName}{" "}
              {payload.lastName} ?
            </p>
            <div className="flex justify-center mt-10">
              <img
                className="size-28 object-cover object-center rounded-full"
                alt="Avatar"
                src={
                  payload?.avatar == null ? imageAvatarDefault : payload?.avatar
                }
                onError={(e) => {
                  e.target.onerror = null; // Ngăn lặp vô hạn
                  e.target.src = imageAvatarDefault; // Đổi sang ảnh mặc định
