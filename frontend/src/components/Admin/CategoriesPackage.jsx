    ...
    <>
      <div className="mt-2 w-6xl mx-auto shadow-item px-4 py-4">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-semibold">Danh mục gói khám</h2>
            ...
            <table className="w-full text-left table-auto min-w-max">
              ...
              <tbody>
                {categoriesPackage.length > 0 &&
                  categoriesPackage.map((item, index) => {
                    return (
      ...
      {isShowModal && (
        <ModalCRUDcategoriesPackage
          type={type}
          setIsShowModal={setIsShowModal}
          fetchCategoriesPackage={fetchCategoriesPackage}
        />
      )}
    </>
  );
