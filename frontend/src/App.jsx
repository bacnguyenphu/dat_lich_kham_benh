...
import {
  Doctor,
  ListMedicalPackgeFollowCategory,
  Specialty,
} from "./components";
import {
  ADMIN,
    ...
    <>
      <Routes>
        <Route path="/" element={<LayoutDefault />}>
          ...
          <Route
            path={`${DOCTORS}/chi-tiet/:idDoctor`}
            element={<DetailDoctor />}
          />
          <Route path={MEDICAL_PACKAGE} element={<Category_Package />} />
          <Route
            path={`${MEDICAL_PACKAGE}/:slug`}
            element={<ListMedicalPackgeFollowCategory />}
          />
          <Route
            path={`${MEDICAL_PACKAGE}/:slug/:id`}
            element={<DetailMedicalPackage />}
          />
        ...
        >
          ...
          <Route path={MANAGE_DOCTOR} element={null}>
            ...
            <Route
              path={MEDICAL_EXAMINATION_PLAN}
              element={<MedicalExaminationPlan type={"DOCTOR"} />}
            />
          </Route>
          <Route path={MANAGE_PACKAGE} element={null}>
            ...
            <Route
              path={PACKAGE_PLAN}
              element={<MedicalExaminationPlan type={"MEDICAL_PACKAGE"} />}
            />
          ...
          <Route path={MANAGE_RECEPTIONIST} element={<ManageReceptionist />} />
        </Route>
