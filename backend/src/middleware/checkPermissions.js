import {
    ...
    GET_SPECIALTY_BY_ID, GET_TIMEFRAMES, GET_USER_BY_ID, LOGIN, LOGIN_DOCTOR, LOGOUT, REFRESH_TOKEN, REGISTER, SEARCH, UPDATE_DOCTOR, UPDATE_STATUS_APPOINTMENT
...
const ROLE_PERMISSIONS = {
    ...
    R2: [GET_APPOINTMENT_OF_DOCTOR, UPDATE_STATUS_APPOINTMENT, GET_APPOINTMENT_OF_USER_FOLLOW_DOCTOR, GET_PATIENT_OF_DOCTOR,
        CREATE_OR_UPDATE_SCHEDULE, CHANGE_PASSWORD_DOCTOR,UPDATE_DOCTOR
    ], // bác sĩ
