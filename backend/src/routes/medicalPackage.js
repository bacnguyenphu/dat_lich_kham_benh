...
} = require("../controllers/medicalPackageController");
const router = express.Router();

router.post(CREATE_MEDICAL_PACKAGE, handleCreateMedicalPackage);
...
router.delete(DELETE_MEDICAL_PACKAGE, handleDeleteMedicalPackage);
router.get(
  GET_MEDICAL_PACKAGE_FOLLOW_CATEGORY,
  handleGetMedicalPackageFollowCategory,
);
